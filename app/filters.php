    ...
    App::singleton('getUserProfile', function() {
        ...
        if (Auth::check()) {
            ...
            if(count($res)) {
                ...
                if(empty($app->USER_PROFILE['firstName']) && empty($app->USER_PROFILE['lastName'])) $app->USER_PROFILE['fullName'] = 'No Name';
...
Route::filter('csrf', function()
{
	if (Session::token() !== Input::get('_token')) {
		// TODO: create a view page and show "Session not found"
