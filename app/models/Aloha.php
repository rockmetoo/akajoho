...
class Aloha extends Eloquent
{
    ...
    {
        $query  = DB::connection('akazohoUsers')->table('users');
    ...
    {
        $query    = DB::connection('akazohoUsers')->table('forgotPasswordVerify');
    ...
    {
        $query    = DB::connection('akazohoUsers')->table('usersVerify');
