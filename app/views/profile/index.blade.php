...
@section('internalJSCode')
    ...
    jQuery(function($) {
    	...
    	$('#dob').datetimepicker({format: 'Y-m-d', lang: 'en'});
                                ...
                                <div class="col-lg-6">
                                	<div class="form-group">
                                    	<label>Date of Birth</label>
                                       	<input type="text" class="form-control" name="dob" id="dob" value="{{ (Input::old('dob')) ? Input::old('dob') : date('Y-m-d', $profile[0]->dob) }}" />
                                        @if ($errors->has('dob')) <ul class="list_of_error" id="list_of_error_dob"><li id="error_item_dob_default">Please enter a valid date of birth</li></ul> @endif
                                    </div>
                                </div>
                                <div class="col-lg-6">
									<div class="form-group">
